...
def UNet(
    ...
    if bayesian:
        ...
        out_std = keras.layers.Conv2D(1, (1,1), activation='softplus', kernel_initializer='glorot_normal')(x_std)
        out_std = tf.keras.layers.Lambda(lambda x: 1e-3 + 0.05*x)(out_std)
