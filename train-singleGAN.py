...
D_0 = dl.sGAN(input_shape=(None,None,2),num_filters=64)
D_1 = dl.sGAN(input_shape=(None,None,2),num_filters=64)
D_2 = dl.sGAN(input_shape=(None,None,2),num_filters=64)
D_3 = dl.sGAN(input_shape=(None,None,2),num_filters=64)
