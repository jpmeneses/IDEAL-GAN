...
python train-IDEAL-GAN.py --dataset 'GAN-230' --adv_train False --n_G_filters 36 --n_downsamplings 4 --n_res_blocks 2 --encoded_size 24 --epochs 10 --epoch_decay 10 --epoch_ckpt 5 --data_aug_p 0.0 --perceptual_loss True --cycle_loss_weight 1e-1 --B2A2B_weight 1e0 --ls_reg_weight 4e-7 --Fourier_reg_weight 0.0 --NL_SelfAttention True
